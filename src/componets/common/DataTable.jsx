...
const DataTable = ({ col, data, isLoading, actions }) => {
  ...
  return (
    ...
    <div className="card">
                              ...
                              <td key={i}>
                                <span
                                  className={`badge badge-${
                                    success.includes(badgeName[rowData[colData.accessor]])
                                      ? "success"
                                      : danger.includes(badgeName[rowData[colData.accessor]])
                                      ? "danger"
                                      : info.includes(badgeName[rowData[colData.accessor]])
                                      ? "info"
                                      : warning.includes(badgeName[rowData[colData.accessor]])
                                      ? "warning"
                                      : "success"
      ...
      {isLoading ? <Loading /> : data && !data.length ? <p className="m-0 fw-bold p-5 text-center"> No Variant </p> : "" }
    </div>
